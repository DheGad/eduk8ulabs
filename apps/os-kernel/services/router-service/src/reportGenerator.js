 ...
 */
export async function generateExecutiveReport(tenant_id, period = "Last 30 Days") {
...
function buildHTMLReport(tenant_id, period, headline, kpis, narrative, merkleHash) {
