...
console.info(`[V18:ApiKeyService] Initialized with ${KEY_STORE.size} keys ` +
 ...
 */
export function generateKey(tenant_id, policy_id, label = "API Key") {
    ...
    console.info(`[V18:ApiKeyService] Generated key key_id=${key_id} tenant=${tenant_id} policy=${policy_id}`);
 ...
 */
export async function validateKey(plaintext) {
 ...
 */
export function revokeKey(key_id) {
