...
export interface VerifiedWorkflow {
  id: string;
  name: string;
  description: string;
  ...
  supported_tenants: string[] | "ALL"; // Array of tenant IDs, or "ALL" for global apps
  required_compliance?: string; // Optional specific framework ID (e.g. GDPR_EU)
}

const VERIFIED_WORKFLOWS: VerifiedWorkflow[] = [
  {
 ...
 */
export function getWorkflowsForTenant(tenantId: string): VerifiedWorkflow[] {
