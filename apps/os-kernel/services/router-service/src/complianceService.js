...
function getTenantMap(tenant_id) {
 ...
 */
export function getTenantCompliance(tenant_id) {
 ...
 */
export function getAllFrameworksForTenant(tenant_id) {
    const map = getTenantMap(tenant_id);
 ...
 */
export function toggleFramework(tenant_id, framework_id, status) {
 ...
 */
export function generateAuditReport(tenant_id) {
